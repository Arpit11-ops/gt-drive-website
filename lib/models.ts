...
export const models: ScooterModel[] = [
  {
    ...
    image: "/assets/gt-drive/gt-soul-sl.png",
    lead: "A clean, composed electric scooter for everyday movement.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-soul-nxt-dl.png",
    lead: "The Soul line, shaped for a sharper urban presence.",
    colors: ["White", "Black", "Grey"], specs: commonSpecs("90-100 - 10"), features: sharedFeatures,
  },
  {
    slug: "gt-ryd", name: "GT - RYD", shortName: "GT RYD", code: "CS",
    image: "/assets/gt-drive/gt-ryd-cs.png",
    lead: "Confident lines and a versatile color range for daily city rides.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-ryd-plus-fh.png",
    lead: "A distinctive evolution of the RYD family with a planted stance.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-one-plus-bmw.png",
    lead: "A focused electric scooter with a compact, contemporary profile.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-champion-cj.png",
    lead: "Extra long wheelbase. New vibrant colors.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-flying-e4.png",
    lead: "Dynamic sporty looks for an energetic road presence.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-drive-pro.png",
    lead: "Purpose-built for today. Prepared for tomorrow.",
  ...
  },
  {
    ...
    image: "/assets/gt-drive/gt-chetak.png",
    lead: "A forthcoming addition to the GT Drive range.", status: "coming-soon",
