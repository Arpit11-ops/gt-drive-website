              ...
              >
                <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-white transition-colors group-hover:ring-1 group-hover:ring-[var(--color-green)]/40">
                  ...
                  {model.status === "coming-soon" && (
                    <span className="absolute left-2 top-2 rounded-full bg-[var(--color-stage)] px-2 py-[3px] text-[9px] font-semibold uppercase tracking-[0.14em] text-[var(--color-green-deep)]">
                      Coming soon
                    </span>
                  )}
                </div>
