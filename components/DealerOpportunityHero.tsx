...
const stats = [
  { value: "09", label: "Models in the range" },
  { value: "05", label: "Plant states" },
  { value: "05", label: "Partner support areas" },
];
    ...
    <section className="bg-white px-4 pb-12 pt-24 md:px-8 md:pb-20 md:pt-28">
      <Reveal className="mx-auto max-w-[var(--container-page)]">
        <div className="group relative h-[680px] overflow-hidden rounded-[28px] bg-[var(--color-ink)] shadow-[0_24px_70px_rgba(17,17,17,0.16)] md:h-[600px]">
          <Image
            src="/assets/gt-drive/gt-drive-pro.png"
          ...
          <div className="relative z-10 flex h-full flex-col justify-between px-7 py-9 md:px-14 md:py-14 lg:px-20">
            <div className="max-w-3xl pt-6 md:pt-10">
              <p className="mb-7 text-xs font-semibold tracking-[0.2em] text-white/75 uppercase">
                Pan-India dealership opportunity
              </p>
              <h1 className="max-w-[760px] text-[clamp(48px,7vw,96px)] leading-[0.88] tracking-[-0.055em] text-white">
          ...
          >
            <div className="relative h-36 overflow-hidden rounded-xl bg-[#eef2ec]">
              <Image
                src="/assets/gt-drive/gt-flying-e4.png"
            ...
            {stats.map((stat, index) => (
              <div key={stat.label} className="flex items-center">
                ...
                <div className="min-w-[145px] px-6 py-4">
                  <div className="text-2xl font-bold tracking-[-0.04em] text-[var(--color-ink)]">{stat.value}</div>
