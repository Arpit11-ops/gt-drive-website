    ...
    <section id="dealer-apply" className="relative overflow-hidden bg-white py-20 md:py-28">
      <div className="mx-auto grid max-w-[var(--container-page)] gap-12 px-6 md:grid-cols-[0.8fr_1.4fr] md:gap-16 md:px-12 lg:px-16">
        <div>
          ...
          <h2 className="font-display text-[clamp(38px,4vw,60px)] font-extrabold leading-[0.96] tracking-[-0.035em] text-[var(--color-ink)]">Ready to partner with GT?</h2>
          <p className="mt-6 max-w-sm text-[15px] leading-relaxed text-[var(--color-body)]">Tell us about your business and preferred location. The same enquiry team handles dealership, fleet, service and media requests.</p>
        </div>
